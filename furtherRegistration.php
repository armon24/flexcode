    ...
    <tr>
        <td>
            <label  id="type">Where are you from? </label>
        </td>
        <td>
            <input type="text" name="state" placeholder="Select a state" list="stateList" />
    ...
    <tr>
        ...
        <td>
            <input type="text" name="minor" placeholder="Select a minor" list="minorList" />
    ...
    <tr>
        ...
        <td>
            <input type="text" name="food" placeholder="Select a dining hall" list="foodList" />
    ...
    <tr>
        ...
        <td>
            <input type="text" name="hobby" placeholder="Select a hobby" list="hobbyList" />
    ...
    <tr>
        ...
        <td>
            <input type="text" name="place" placeholder="Select a place" list="placeList" />
    ...
    <tr>
        ...
        <td>
            <input type="text" name="dorm" placeholder="Select a dorm" list="dormList" />
    ...
    <tr>
        ...
        <td>
            <input type="text" name="advice" placeholder="Select a concept" list="adviceList" />
